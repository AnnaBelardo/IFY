...
public class UtenzaService {
	...
	private UtenteRepository utenteRepository;
	  ...
	  /**
	   * Controlla che l'email di un utente sia specificata e che rispetti il formato prestabilito.
	   * Controlla inolte che tale email non sia già presente nel sistema.
	   * 
	  ...
	  /**
	   * Permette di specificare l'utente autenticato nel sistema, tramite l'email, in una variabile
	   ...
	   * 
	   * @param email Stringa relativa all'email dell'utente che si vuole autenticare nel sistema
	   */
