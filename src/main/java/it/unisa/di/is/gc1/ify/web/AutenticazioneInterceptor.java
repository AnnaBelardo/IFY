...
/**
 * Interceptor che si occupa di trasferire l'email dell'utente autenticato dalla sessione HTTP
...
public class AutenticazioneInterceptor extends HandlerInterceptorAdapter {
  ...
  public boolean preHandle(HttpServletRequest request,
    ...
    // Ottieni l'email dell'utente autenticato e propaga l'informazione anche a livello più basso
