...
public interface RichiestaIscrizioneRepository extends JpaRepository<RichiestaIscrizione, Long> {
		...
		/**
		* Permette di ottenere l'elenco delle richiesta di iscrizione con un determinato stato.
		* 
		* @param stato Stringa che rappresenta lo stato della richiesta di iscrizione
		*           
		* @return Lista di {@link RichiestaIscrizione} che rappresenta la lista delle richieste di iscrizione
		* 		  <b>Può essere vuota</b> se nel database non sono presenti richieste di iscrizione 
		* 		  cone lo stato passato come parametro
		*                                         
		* @pre stato = {@link RichiestaIscrizione#IN_ATTESA} or
		*      stato = {@link RichiestaIscrizione#ACCETTATA} or
		*      stato = {@link RichiestaIscrizione#RIFIUTATA}
		*/
		...
		* 
		* @param id Long che rappresenta l'id dello studente per cui si cerca la richiesta
		* 
		* @return Oggetto {@link RichiestaIscrizione} che rappresenta la richiesta di iscrizione.
		* 
		* @pre id > 0
		*/
