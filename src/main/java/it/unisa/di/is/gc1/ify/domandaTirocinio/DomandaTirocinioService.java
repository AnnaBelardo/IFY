...
/**
* La classe fornisce i metodi per la logica di business per la gestione delle richieste d'iscrizione
* 
...
public class DomandaTirocinioService {
	...
	/**
	 * Il metodo fornisce la funzionalità di accettazione aziendale di una domanda di tirocinio
	 * 
	 * 
	 * @param idDomanda
	 * @return Oggetto {@link DomandaTirocinio} che rappresenta la domanda di tirocinio approvata
	 * 
	 */
	
	@Transactional(rollbackFor = Exception.class)
	public DomandaTirocinio accettaDomandaTirocinio(Long idDomanda)
	...
	/**
	 * Il metodo fornisce la funzionalità di rifiuto aziendale di una domanda di tirocinio
	 * 
	 * 
	 * @param idDomanda
	 * @return Oggetto {@link DomandaTirocinio} che rappresenta la domanda di tirocinio rifiutata
	 * 
	 */
	
	@Transactional(rollbackFor = Exception.class)
	public DomandaTirocinio rifiutoDomandaTirocinio(Long idDomanda)
			throws OperazioneNonAutorizzataException {
	...
	/**
	 * Il metodo fornisce la funzionalità di approvazione dell'ufficio tirocini di una domanda di tirocinio
	 * 
	 * 
	 * @param idDomanda
	 * @return Oggetto {@link DomandaTirocinio} che rappresenta la domanda di tirocinio rifiutata
	...
	@Transactional(rollbackFor = Exception.class)
	public DomandaTirocinio approvazioneDomandaTirocinio(Long idDomanda)
			throws OperazioneNonAutorizzataException {
	...
	/**
	 * Il metodo fornisce la funzionalità di respinta dell'ufficio tirocini di una domanda di tirocinio
	 * 
	 * 
	 * @param idDomanda
	 * @return Oggetto {@link DomandaTirocinio} che rappresenta la domanda di tirocinio rifiutata
	...
	@Transactional(rollbackFor = Exception.class)
	public DomandaTirocinio respintaDomandaTirocinio(Long idDomanda)
			throws OperazioneNonAutorizzataException {
	...
	/** Il metodo fornisce la funzionalità di visualizzazione delle domande di tirocinio in attesa
	 * 
	 ...
	 *         sono presenti domande di tirocinio di quella determinata azienda
	 */	
	@Transactional(rollbackFor = Exception.class)
	public List<DomandaTirocinio> visualizzaDomandeTirocinioInAttesaAzienda(String piva) 
		...
		//Solo il delegato aziendale può visualizzare le domande di tirocinio in attesa dell'azienda
		if(!(utente instanceof DelegatoAziendale)) {
			throw new OperazioneNonAutorizzataException();
		}
		DelegatoAziendale delegatoAziendale=(DelegatoAziendale) utente;
		
		//Le domande di tirocinio di un'azienda possono essere visualizzate solo dal delegato aziendale dell'azienda stessa
		if(!(delegatoAziendale.getAzienda().getpIva().equals(piva))) {
			throw new OperazioneNonAutorizzataException();
		}
			
		List<DomandaTirocinio> domandeTirocinio = domandaTirocinioRepository.findAllByAziendaPIvaAndStato(piva, DomandaTirocinio.IN_ATTESA);

		return domandeTirocinio;
	}
	
	
	/** Il metodo fornisce la funzionalità di visualizzazione delle domande di tirocinio inoltrate
	 * 
	 * @return Lista di {@link DomandaTirocinio} che rappresenta la lista delle
	 *         domande di tirocinio <b>Può essere vuota</b> se nel database non
	 *         sono presenti domande di tirocinio di quella determinata azienda
	...
	public List<DomandaTirocinio> visualizzaDomandeTirocinioInoltrateAzienda(String piva) 
		...
		//Solo il delegato aziendale può visualizzare le domande di tirocinio inoltrate dell'azienda
		if(!(utente instanceof DelegatoAziendale)) {
			throw new OperazioneNonAutorizzataException();
		}
		DelegatoAziendale delegatoAziendale=(DelegatoAziendale) utente;
		...
		domandeTirocinio.addAll(domandaTirocinioRepository.findAllByAziendaPIvaAndStato(piva, DomandaTirocinio.ACCETTATA));
		domandeTirocinio.addAll(domandaTirocinioRepository.findAllByAziendaPIvaAndStato(piva, DomandaTirocinio.APPROVATA));
		domandeTirocinio.addAll(domandaTirocinioRepository.findAllByAziendaPIvaAndStato(piva, DomandaTirocinio.RESPINTA));

		return domandeTirocinio;
	}
	
	
	/** Il metodo fornisce la funzionalità di visualizzazione dei tirocini in corso dell'azienda
	 * 
	 * @return Lista di {@link DomandaTirocinio} che rappresenta la lista delle
	 *         domande di tirocinio <b>Può essere vuota</b> se nel database non
	 *         sono presenti domande di tirocinio di quella determinata azienda e in corso
	 */	
	@Transactional(rollbackFor = Exception.class)
	public List<DomandaTirocinio> visualizzaTirociniInCorsoAzienda(String piva) 
		...
		//I tirocini in corso di un'azienda possono essere visualizzate dall'azienda stessa
		if(!(delegatoAziendale.getAzienda().getpIva().equals(piva))) {
			throw new OperazioneNonAutorizzataException();
		}
			
		List<DomandaTirocinio> domandeTirocinio = domandaTirocinioRepository.findAllByAziendaPIvaAndStato(piva, DomandaTirocinio.APPROVATA);
	...
	/** Il metodo fornisce la funzionalità di visualizzazione delle domande di tirocinio inoltrate da uno studente
	 * 
	 * @return Lista di {@link DomandaTirocinio} che rappresenta la lista delle
	 *         domande di tirocinio <b>Può essere vuota</b> se nel database non
	 *         sono presenti domande di tirocinio di quel determinato studente
	 */	
	@Transactional(rollbackFor = Exception.class)
	public List<DomandaTirocinio> visualizzaDomandeTirocinioInoltrateStudente(Long id) 
		...
		//Le domande di tirocinio di uno studente possono essere visualizzate dallo studente stesso
	...
	/** Il metodo fornisce la funzionalità di visualizzazione dei tirocini in corso di uno studente
	 * 
	 * @return Lista di {@link DomandaTirocinio} che rappresenta la lista delle
	 *         domande di tirocinio <b>Può essere vuota</b> se nel database non
	 *         sono presenti domande di tirocinio di quel determinato studente e in corso
	 */	
	@Transactional(rollbackFor = Exception.class)
	public List<DomandaTirocinio> visualizzaTirociniInCorsoStudente(Long id) 
			throws OperazioneNonAutorizzataException {
		...
		//I tirocini in corso di uno studente possono essere visualizzate dallo studente stesso
		if(!(studente.getId() == id)) {
			throw new OperazioneNonAutorizzataException();
		}
			
		List<DomandaTirocinio> domandeTirocinio = domandaTirocinioRepository.findAllByStudenteIdAndStato(id, DomandaTirocinio.APPROVATA);
		List<DomandaTirocinio> tirociniInCorso = new ArrayList<DomandaTirocinio>();
	...
	/** Il metodo fornisce la funzionalità di visualizzazione delle domande di tirocinio in attesa dell'ufficio
	 * 
	 * @return Lista di {@link DomandaTirocinio} che rappresenta la lista delle
	 *         domande di tirocinio <b>Può essere vuota</b> se nel database non
	 *         sono presenti domande di tirocinio in attesa dell'ufficio
	 */	
	@Transactional(rollbackFor = Exception.class)
	public List<DomandaTirocinio> visualizzaDomandeTirocinioInAttesaUfficio() 
			throws OperazioneNonAutorizzataException {
		
		Utente utente = utenzaService.getUtenteAutenticato();
		
		//Solo il responsabile ufficio può visualizzare le domande di tirocinio in attesa dell'ufficio
		if(!(utente instanceof ResponsabileUfficioTirocini)) {
			throw new OperazioneNonAutorizzataException();
		}
	...
	/** Il metodo fornisce la funzionalità di visualizzazione delle domande di tirocinio valutate dall'ufficio
	 * 
	 * @return Lista di {@link DomandaTirocinio} che rappresenta la lista delle
	 *         domande di tirocinio <b>Può essere vuota</b> se nel database non
	 *         sono presenti domande di tirocinio valutate dall'ufficio
	 */	
	@Transactional(rollbackFor = Exception.class)
	public List<DomandaTirocinio> visualizzaDomandeTirocinioValutateUfficio() 
			throws OperazioneNonAutorizzataException {
		
		Utente utente = utenzaService.getUtenteAutenticato();
		
		//Solo il responsabile ufficio può visualizzare le domande di tirocinio valutate dall'ufficio
		if(!(utente instanceof ResponsabileUfficioTirocini)) {
			throw new OperazioneNonAutorizzataException();
		}
	...
	/** Il metodo fornisce la funzionalità di visualizzazione dei tirocini in corso ufficio
	 * 
	 * @return Lista di {@link DomandaTirocinio} che rappresenta la lista dei tirocini
	 *         in corso <b>Può essere vuota</b> se nel database non
	 *         sono presenti tirocini in corso
	 */	
	@Transactional(rollbackFor = Exception.class)
	public List<DomandaTirocinio> visualizzaTirociniInCorsoUfficio() 
			throws OperazioneNonAutorizzataException {
	 ...
	 */
		public String validaConoscenze(String conoscenze) throws DomandaTirocinioNonValidaException {
			if (conoscenze == null)
				throw new DomandaTirocinioNonValidaException("ConoscenzeError", "Il campo conoscenze non può essere nullo.");
			
			if (conoscenze.length() < DomandaTirocinio.MIN_LUNGHEZZA_CONOSCENZE)
				throw new DomandaTirocinioNonValidaException("ConoscenzeError", "il campo Conoscenze Tecniche deve contenere almeno un carattere.");
			
			if (conoscenze.length() > DomandaTirocinio.MAX_LUNGHEZZA_CONOSCENZE)
				throw new DomandaTirocinioNonValidaException("ConoscenzeError", "il campo Conoscenze Tecniche deve contenere al massimo 200 caratteri.");
			return conoscenze;
		}
		...
		public String validaMotivazioni(String motivazioni) throws DomandaTirocinioNonValidaException {
			if (motivazioni == null)
				throw new DomandaTirocinioNonValidaException("MotivazioniError", "Il campo motivazioni non può essere nullo.");
			
			if (motivazioni.length() < DomandaTirocinio.MIN_LUNGHEZZA_MOTIVAZIONI)
				throw new DomandaTirocinioNonValidaException("MotivazioniError", "il campo Motivazioni deve contenere almeno un carattere.");
			
			if (motivazioni.length() > DomandaTirocinio.MAX_LUNGHEZZA_MOTIVAZIONI)
				throw new DomandaTirocinioNonValidaException("MotivazioniError", "il campo Motivazioni deve contenere al massimo 300 caratteri.");
			return motivazioni;
		}
		...
		public LocalDate validaDataInizio(LocalDate dataInizio) throws DomandaTirocinioNonValidaException {
			if (dataInizio == null)
				throw new DomandaTirocinioNonValidaException("dataInizioError", "Il campo data inizio non può essere nullo.");
			
			if (!dataInizio.isAfter(DomandaTirocinio.MIN_DATE_INIZIO))
				throw new DomandaTirocinioNonValidaException("dataInizioError", "Il campo Data Inizio Tirocinio deve contenere una data maggiore della data corrente.");
			return dataInizio;
		}
		...
		public LocalDate validaDataFine(LocalDate dataInizio, LocalDate dataFine) throws DomandaTirocinioNonValidaException {
			...
			if (!dataFine.isAfter(dataInizio))
				throw new DomandaTirocinioNonValidaException("dataFineError", "il campo Data Fine Tirocinio deve contenere una data di fine maggiore della data di inizio del tirocinio.");
			return dataFine;
		}
		...
		public String validaCondizioni(String condizioni) throws DomandaTirocinioNonValidaException {
			if (condizioni == null)
				throw new DomandaTirocinioNonValidaException("CondizioniError", "È obbligatorio accettare le condizioni sulla privacy.");
