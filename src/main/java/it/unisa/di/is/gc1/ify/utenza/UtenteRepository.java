 ...
 * alle informazioni persisteti relative ad un utente registrato alla piattaforma
 *
 * @see Utente
 */
...
public interface UtenteRepository extends JpaRepository<Utente, Long> {
	  ...
	  /**
	   * Permette di ottenere un utente a partire dalle proprie credenziali di accesso.
	   * 
